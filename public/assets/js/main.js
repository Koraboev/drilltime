...
--------------------------------------------------------------*/
 ...
 -----------------------------------------------------------------*/
    function mainNav() {
        $(".ak-nav").append(
            '<span class="ak-munu_toggle"><span></span></span>'
        );
        ...
        $(".ak-animo_links > li > a").each(function () {
            ...
            $(this).html(
                `<span class="ak-animo_text"><span>${xxx}</span></span>`
            );
        });
    }
    /*--------------------------------------------------------------
    ...
    function stickyHeader() {
        ...
        $window.scroll(function () {
            ...
            if ($header.hasClass("ak-gescout_sticky")) {
                ...
                else $header.removeClass("ak-gescout_show");
            }
...
-------------------------------------------------------------*/
 ...
 --------------------------------------------------------------*/
    ...
    function swiperInit() {
        ...
        if ($(".ak-slider-hero-2").length) {
            var swiperOptions = {
                loop: true,  // loop ni faollashtirish
                speed: 1200,
                parallax: true,
                zoom: {
                    maxRatio: 5,
            ...
            var swiper = new Swiper(".ak-slider-hero-2", swiperOptions);
        }
 ...
 --------------------------------------------------------------*/
    function modalVideo() {
        ...
        $(".ak-video-popup-close, .ak-video-popup-layer").on(
            "click",
            function (e) {
...
--------------------------------------------------------------*/
    ...
    function showScrollUp() {
        ...
        if (scroll >= 350) $(".ak-scrollup").addClass("ak-scrollup-show");
        else $(".ak-scrollup").removeClass("ak-scrollup-show");
    }
 ...
 --------------------------------------------------------------*/
    ...
    if ($.exists(".sticky-content.style-two")) {
        if ($(".sticky-content.style-two").length) {
            ...
            const sidebarHeight = $sidebar.innerHeight();
            const footerOffsetTop = $(".scroll-end-point.style-two").offset()
                .top;
            const sidebarOffset = $sidebar.offset();
            const footerThreshold = footerOffsetTop - sidebarHeight;
            let isScrolling = false;
...
--------------------------------------------------------------*/
    if ($.exists(".auto-counter-section")) {
        ...
        $(window).scroll(function () {
            var oTop =
                $(".ak-funfact-number").offset().top - window.innerHeight;
...
--------------------------------------------------------------*/
    if ($.exists("#contact-form")) {
        ...
        $("#contact-form #submit").on("click", function () {
            ...
            } else $("#ak-alert").fadeIn().html('<div class="alert rounded-0 alert-danger"><strong>Warning!</strong> All fields are required.</div>');
            return false;
        });
    }
...
--------------------------------------------------------------*/
    if ($.exists("#footer-email")) {
        ...
        $("#footer-email #footerSubmit").on("click", function (e) {
            ...
            if (footerEmail != "") {
                var values = { footerEmail: footerEmail };
            ...
            } else $("#ak-alert-footer").fadeIn().html('<p class="text-danger"><strong>Warning!</strong> All fields are required.</p>');
            return false;
        });
    }
    //end the scripts
